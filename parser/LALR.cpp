...
int main()
{
    ...
    for(int i=0;i<no_state;i++)
    {
        ...
        for(;it3!=IM.end();it3++){
            if(it3->second != '@')
            {
                if(!islower(it3->second) && it3->second!='$')
                    cout<<it3->second<<" (G"<<Table[i][it3->first].state<<" )"<<" ";
                else if(Table[i][it3->first].action == 1)
                    cout<<it3->second<<" (S"<<Table[i][it3->first].state<<" )"<<" ";
                else if(Table[i][it3->first].action == 2)
                    cout<<it3->second<<" (R"<<Table[i][it3->first].state<<" )"<<" ";
